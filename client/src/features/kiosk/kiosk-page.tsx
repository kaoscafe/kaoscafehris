  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column", background: "linear-gradient(180deg, #fdfbfb 0%, #faf6f6 40%, #f7efef 100%)", fontFamily: "'Inter', sans-serif" }}>
      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", padding: "40px" }}>
        ...
        <div style={{ maxWidth: 600, width: "100%", background: "#fff", borderRadius: 16, boxShadow: "0 1px 3px rgba(0,0,0,0.06), 0 4px 16px rgba(140,21,21,0.06)", border: "1px solid rgba(0,0,0,0.04)" }}>
          <div style={{ height: 4, background: `linear-gradient(90deg, ${BRAND}, #c0392b, ${ROSE})` }} />
          <div style={{ padding: "28px 28px 0" }}>
            <div style={{ display: "flex", alignItems: "center", gap: 14, marginBottom: 22 }}>
              <div style={{ width: 48, height: 48, borderRadius: "50%", background: `linear-gradient(135deg, ${BRAND}, ${DARK})`, display: "flex", alignItems: "center", justifyContent: "center", color: "#fff", fontWeight: 800, fontSize: 16, flexShrink: 0 }}>
                {initials}
              </div>
          ...
          <div style={{ padding: "0 28px" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 14 }}>
              ...
              <span style={{ display: "inline-flex", alignItems: "center", gap: 5, fontSize: 11, fontWeight: 700, background: badge.bg, color: badge.color, borderRadius: 20, padding: "4px 12px", letterSpacing: 0.3 }}>
        ...
        <div style={{ background: "#fff", borderRadius: 20, padding: "32px", boxShadow: "0 1px 3px rgba(0,0,0,0.06), 0 4px 20px rgba(140,21,21,0.08)", border: "1px solid rgba(0,0,0,0.04)" }}>
          ...
          {!isClockedIn && (
            <div style={{ marginBottom: 24 }}>
              <div style={{ fontSize: 12, color: "#aaa", textTransform: "uppercase", letterSpacing: 0.5, fontWeight: 600, marginBottom: 8 }}>Note (optional)</div>
              <textarea
                value={clockInNote}
                ...
                rows={3}
                disabled={loading}
                style={{ width: "100%", borderRadius: 12, border: "1.5px solid #e5e5e5", padding: "12px 14px", fontSize: 14, color: NEAR_BLACK, resize: "none", outline: "none", fontFamily: "inherit", boxSizing: "border-box", background: loading ? "#f9f9f9" : "#fafafa", transition: "border-color 0.15s" }}
          ...
          {isClockedIn && (
            <div style={{ marginBottom: 24 }}>
              <div style={{ fontSize: 12, color: "#aaa", textTransform: "uppercase", letterSpacing: 0.5, fontWeight: 600, marginBottom: 8 }}>Reason for clocking out (optional)</div>
              <textarea
                value={clockOutNote}
          ...
          <div style={{ display: "flex", gap: 14, marginBottom: 24 }}>
            <button
              onClick={onRetake}
              disabled={loading}
              style={{ flex: 1, padding: "14px", borderRadius: 12, border: "1.5px solid #e5e5e5", background: "#fff", color: "#555", fontSize: 14, fontWeight: 600, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: 7, opacity: loading ? 0.5 : 1, transition: "background 0.15s" }}
            >
            ...
            <button
              onClick={onConfirm}
              disabled={loading}
              style={{ flex: 1.6, padding: "14px", borderRadius: 12, border: "none", background: isClockedIn ? "#b91c1c" : "#15803d", color: "#fff", fontSize: 14, fontWeight: 700, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: 7, boxShadow: isClockedIn ? "0 4px 14px rgba(185,28,28,0.3)" : "0 4px 14px rgba(21,128,61,0.3)", opacity: loading ? 0.7 : 1, transition: "opacity 0.15s" }}
            >
              {loading ? (
          ...
          <div style={{ borderTop: "1px solid #f0e6e6", paddingTop: 20 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 18 }}>
              <div style={{ width: 44, height: 44, borderRadius: "50%", background: `linear-gradient(135deg, ${BRAND}, ${DARK})`, display: "flex", alignItems: "center", justifyContent: "center", color: "#fff", fontWeight: 800, fontSize: 15, flexShrink: 0 }}>
...
function SuccessScreen({
  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column", background: `linear-gradient(160deg, ${DARK} 0%, ${BRAND} 55%, #a01818 100%)`, fontFamily: "'Inter', sans-serif" }}>
      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "0 40px", maxWidth: 560, margin: "0 auto", width: "100%", boxSizing: "border-box" }}>
        <div style={{ width: 112, height: 112, borderRadius: "50%", background: "rgba(255,255,255,0.12)", display: "flex", alignItems: "center", justifyContent: "center", marginBottom: 20, border: "2px solid rgba(255,255,255,0.2)" }}>
        ...
        <div style={{ marginTop: 32, background: "rgba(255,255,255,0.08)", borderRadius: 18, padding: "24px 28px", width: "100%", backdropFilter: "blur(8px)", border: "1px solid rgba(255,255,255,0.12)" }}>
      ...
      <div style={{ padding: "0 40px 56px", display: "flex", flexDirection: "column", alignItems: "center", gap: 16, maxWidth: 560, margin: "0 auto", width: "100%", boxSizing: "border-box" }}>
        ...
        <button
          onClick={onReturnNow}
          style={{ background: "rgba(255,255,255,0.08)", border: "1px solid rgba(255,255,255,0.18)", borderRadius: 10, padding: "12px 32px", color: "rgba(255,255,255,0.7)", fontSize: 14, fontWeight: 600, cursor: "pointer" }}
        >
          Return to Login Now
        </button>
      </div>
...
function BlockedScreen() {
  return (
    <div
      className="relative flex min-h-screen flex-col items-center justify-center px-6 overflow-hidden"
      style={{ backgroundImage: "url('/login-bg.jpg')", backgroundSize: "cover", backgroundPosition: "center", fontFamily: "'Inter', sans-serif" }}
    >
      <div className="pointer-events-none absolute inset-0" style={{ backgroundColor: "rgba(0,0,0,0.4)" }} />
...
export default function KioskPage() {
  ...
  // On mount: ping kiosk to check IP allowlist, then validate any saved PIN
  // against the server. If the admin changed the PIN, the saved one will fail
  // and the device is sent back to the PIN setup screen automatically.
  useEffect(() => {
    pingKiosk()
      .then(async () => {
        ...
        // Validate saved PIN — if admin changed it, force re-entry.
        const valid = await validateKioskPin(saved);
        if (valid) {
          setPin(saved);
          setScreen("id-entry");
        } else {
  ...
  async function handleLookup(empId: string, password: string) {
    ...
    try {
      ...
      // 403 = invalid kiosk PIN (admin changed it) → clear saved PIN, force re-setup
      // 401 = wrong employee credentials → show error, keep PIN intact
  ...
  async function handleConfirm() {
    ...
    try {
      ...
      try {
        ...
        // keep stale data, error still shown
      }
      setConfirmError(msg);
      setScreen("main");
    } finally {
